...
def hello():
    ...
    users = [
        ...
        {'id': 13, 'name': 'Chris Hemsworth', 'age': 1500},
        {'id': 14, 'name': 'Steven Wong', 'age': 42},
        {'id': 15, 'name': 'Samuel L. Jackson', 'age': 79},
    ...
    return render_template('index.html', message=title_message, users=users)
